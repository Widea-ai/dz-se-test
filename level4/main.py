...
class App:
    def __init__(self, input):
        ...
        for rental in input['rentals']:
            ...
            self.driver.rentals.append(rental['id'])
    ...
    def generate_actions_report(self):
        results = {'rentals': []}
        for rental in self.rentals:
            rental_actions = {'id': rental.id, 'actions': []}
